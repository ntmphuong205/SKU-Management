#!/usr/bin/env python3
"""Generate v88: micro day-of-week adjustment on v77.
...
def main():
    ...
    ap.add_argument("--output", default="submission_v88_DOW_MICRO_ADJUST_on_v77.csv")
    args = ap.parse_args()
    ...
    adj[active] = np.clip(1 + 0.10 * (factors[active] - 1), 0.97, 1.03)
